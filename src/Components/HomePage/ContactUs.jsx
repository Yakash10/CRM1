    ...
    return (
      <>
        <div className="max-w-6xl mx-auto p-4 font-poppins">
          {/* Breadcrumb */}
          <div className="text-sm text-gray-600 mb-6">Home &gt; Contact us</div>
          ...
          <p className="text-gray-700 mb-8 max-w-2xl">
            ...
            RealEstateIndia.com would help you to get quotes for your Business.
          </p>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="lg:w-1/2">
              ...
              <button className=" text-gray-700 transition-colors">
                Click here to share your queries / feedback
              </button>
            </div>
