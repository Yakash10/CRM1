  ...
  return (
    <>
      ...
      <button
        ...
        className="p-2 mt-3 mb-3 ms-3 bg-black rounded-lg text-white w-[100px] text-center"
      >
        Admin
      </button>
      <button
      ...
      <button
        ...
        className="p-2 mt-3 mb-3 ms-3 bg-black rounded-lg text-white w-[200px] text-center"
      >
        Property management
      </button>
    </>
